...
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
    $(".MainImageshuttle").bgswitcher({
        images: ["/images/DefaultHome3.jpg"], interval: 7000
...
$(".MainImageshuttle").bgswitcher({
    images: ["/images/DefaultHome3.jpg", "/images/DefaultHome4.jpg", "/images/DefaultHome5.jpg"], interval: 7000
